...
SolveClass = SimulationSolver(FenicsMesh, friction_coefficient=3.8E6/(seconds_per_year**(1/3)), solver_tolerance=1E-4, viscosity_type = 'glen', creep_parameter=3.5E-25*seconds_per_year, save_all=False, save_mesh=True)
