...
def makeImages(iter, snapshots, geometryX, geometryY, data_names, folder_name, time):
    ...
    for n in range(len(snapshots)):
        ...
        plt.sca(axes[n])
        plt.xticks([49000, 50000, 51000, 52000, 53000, 54000], ["49.0", "50.0", "51.0", "52.0", "53.0", "54.0"])

        os.chdir(root_directory)

    plt.sca(axes[0])
    plt.xticks([49000, 50000, 51000, 52000, 53000, 54000], [])
    ...
    fig.savefig(folder_name + "/" + "animation_slippery" + str(iter) + ".png", transparent=False, dpi=300)
    plt.close(fig)
...
if __name__ == "__main__":
    ...
    folder_name = "animation_slippery"
    ...
    for i in range(len(times)):
        imraw = mpimg.imread("animation_slippery" + str(i) + ".png")
    ...
    ani.save("animation_slippery.mp4", writer=writer, dpi=300) #dpi=500
