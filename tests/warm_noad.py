...
setup_folder(sim_name, parameter_file_name, extra_files=['warm_ss_mesh.xml'])
...
FenicsMesh.load_mesh('warm_ss_mesh.xml')

seconds_per_year = 3.154E7
SolveClass = SimulationSolver(FenicsMesh, friction_coefficient=7.6E6/(seconds_per_year**(1/3)), solver_tolerance=1E-4, viscosity_type = 'glen', creep_parameter=1.7E-24*seconds_per_year, save_all=False, save_mesh=True, advect=False, calving_type='particle', calving_start=0.5, yield_width=0.0099)
